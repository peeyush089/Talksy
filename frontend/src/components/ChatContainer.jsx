...
const ChatContainer = () => {
  ...
  // ─── Mobile top bar ────────────────────────────────────────────────────────
  const MobileBar = () => (
    <div className="md:hidden flex items-center gap-3 px-3 py-2 border-b border-base-300 bg-base-100">
      <button
  ...
  if (isMessagesLoading) {
    return (
      <div className={`flex-1 flex-col overflow-auto ${chatVisibility}`}>
        <MobileBar />
        <ChatHeader />
        <MessageSkeleton />
        <MessageInput />
